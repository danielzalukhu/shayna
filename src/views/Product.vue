            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text product-more">
                        <router-link to="/"><a href="./home.html"><i class="fa fa-home"></i> Home</a></router-link>
                        <span>Detail</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" :src="defaultPicture" alt="" />
                            </div>
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <!-- Buat event ketika gambar kecil dipilih, maka gambar besarnya akan sesuai dengan gambar kecil yang dipilih -->
                                    <!-- Kemudian, buat if conditional untuk "aktiv" atau tidaknya suatu gambar yang dipilih -->
                                    <!-- Kalau gambar yang dipilih tampil pada gambar default atau yang besarnya  -->
                                    <!-- Maka kotak gambar kecil akan ada aksen lis yang "aktiv" -->
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == defaultPicture ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == defaultPicture ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == defaultPicture ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == defaultPicture ? 'active' : '' ">
